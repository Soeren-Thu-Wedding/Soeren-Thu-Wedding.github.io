...
After the wedding was over, it was moved over to a static site.

The static site is hosted on GitHub Pages. It can be generated by running

```bash
$ python manage.py distill-local --force --collectstatic
```

The domain <https://www.soeren-thu-wedding.com/> is pointing to the static GitHub Pages site.
