...
#     list_display = ('name', 'type', 'language', 'category', 'save_the_date_sent', 'invitation_sent', 'rehearsal_dinner', 'invitation_opened',
...
#     list_filter = ('is_attending', 'is_child', 'meal', 'party__language', 'party__is_invited', 'party__category', 'party__rehearsal_dinner')
